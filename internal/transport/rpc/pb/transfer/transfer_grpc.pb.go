...
type OperationServiceClient interface {
	OperationList(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*OperationResponseList, error)
}
...
func (c *operationServiceClient) OperationList(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*OperationResponseList, error) {
...
type OperationServiceServer interface {
	OperationList(context.Context, *EmptyRequest) (*OperationResponseList, error)
}
...
func (UnimplementedOperationServiceServer) OperationList(context.Context, *EmptyRequest) (*OperationResponseList, error) {
...
func _OperationService_OperationList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperationServiceServer).OperationList(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
